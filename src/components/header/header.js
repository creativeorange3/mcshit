          ...
          >
            <Container>
              <Box sx={styles.headerInner}>
                <Image src={logo} sx={styles.logo} isSticky={state.isSticky} />
                <Flex
                  as="nav"
                  sx={styles.navbar}
                ...
                <a href='https://poocoin.app/tokens/0x7c59a57fc16eac270421b74615c4bc009ecd486d' target={'_blank'} style={{ textDecoration: 'none' }}>
